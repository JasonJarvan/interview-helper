...
def create_ui_components(root):
    ...
    transcript_textbox = ctk.CTkTextbox(root, width=300, font=("Arial", font_size), text_color='#000000', wrap="word", fg_color='#FFFFFF')
    transcript_textbox.grid(row=0, column=0, padx=10, pady=20, sticky="nsew")

    response_textbox = ctk.CTkTextbox(root, width=300, font=("Arial", font_size), text_color='#000000', wrap="word", fg_color='#FFFFFF')
...
def main():
    ...
    clear_transcript_button = ctk.CTkButton(root, text="清空转录记录", command=lambda: clear_context(transcriber, audio_queue, ))
